...
internal class Altaircam : IDisposable
{
    [Flags]
    ...
    /* get the version of this dll/so, which is: 60.31589.20260531 */
    public static string Version()
    {
        if (IsWindows())
            return Marshal.PtrToStringUni(Altaircam_Version());
        else
            return Marshal.PtrToStringAnsi(Altaircam_Version());
    }
    ...
    */
    ...
    public static int PciEnable(DelegateHotplug funHotplug)
    {
        ...
        IntPtr id = new IntPtr(Interlocked.Increment(ref sid_));
        map_.Add(id.ToInt32(), funHotplug);
        return Altaircam_PciEnable(pHotplug, id);
    }
    ...
    */
    public static int CtiEnable(DelegateHotplug funHotplug, string[] ctiPath)
    {
        ...
        map_.Add(id.ToInt32(), funHotplug);
        if (PtrArray == null)
            return Altaircam_CtiEnable(pHotplug, id, IntPtr.Zero);
        else {
            GCHandle gch = GCHandle.Alloc(PtrArray, GCHandleType.Pinned);
            try {
                return Altaircam_CtiEnable(pHotplug, id, gch.AddrOfPinnedObject());
            }
            finally {
                gch.Free();
            }
    ...
    */
    ...
    public static Altaircam Open(string camId)
    {
        ...
        SafeCamHandle tmphandle = Altaircam_Open(camIdHandle.Get());
    ...
    */
    ...
    public string Name
    {
        get
        {
            ...
            if (Altaircam_query_Name(handle_, ptr) >= 0)
                str = Marshal.PtrToStringAnsi(ptr);
            Marshal.FreeHGlobal(ptr);
            return str;
        }
    ...
    public bool PullImagePtr(int bStill, ref ImagePtr ptrImage)
    {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Altaircam_PullImagePtr(handle_, bStill, out ptrImage));
    }
    ...
    */
    public bool WaitImagePtr(uint waitMS, int bStill, ref ImagePtr ptrImage)
    {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Altaircam_WaitImagePtr(handle_, waitMS, bStill, out ptrImage));
    }
    ...
    */
    ...
    public bool WaitImage(uint waitMS, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo)
    {
        ...
        return CheckHResult(Altaircam_WaitImageV4(handle_, waitMS, pImageData, bStill, bits, rowPitch, out pInfo));
    }
    ...
    public bool WaitImageV3(uint waitMS, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo)
    {
        ...
        return CheckHResult(Altaircam_WaitImageV3(handle_, waitMS, pImageData, bStill, bits, rowPitch, out pInfo));
    }
    ...
    */
    public bool TriggerSync(uint waitMS, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV4 pInfo)
    {
        ...
        return CheckHResult(Altaircam_TriggerSyncV4(handle_, waitMS, pImageData, bits, rowPitch, out pInfo));
    }
    ...
    public bool TriggerSync(uint waitMS, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV3 pInfo)
    {
        ...
        return CheckHResult(Altaircam_TriggerSync(handle_, waitMS, pImageData, bits, rowPitch, out pInfo));
    }
    ...
    */
    public bool get_AutoExpoEnable(out int mode)
    {
        ...
        return CheckHResult(Altaircam_get_AutoExpoEnable(handle_, out mode));
    }
    ...
    */
    ...
    {
        return (Altaircam_put_Option(null, iOption, iValue) >= 0);
    }
    ...
    {
        return (Altaircam_get_Option(null, iOption, out iValue) >= 0);
    }
    ...
    */
    ...
    public bool readPtr(string key, int len, out byte[] data)
    {
        ...
        try {
            if (CheckHResult(Altaircam_readPtr(handle_, key, len, handle.AddrOfPinnedObject()))) {
                data = buffer;
                return true;
            }
        }
    ...
    */
    public bool readPtr<T>(string key, out T data) where T : struct
    {
        ...
        try {
            if (CheckHResult(Altaircam_readPtr(handle_, key, len, buffer))) {
    ...
    public bool writePtr(string key, byte[] data)
    {
        ...
        if (data == null || data.Length == 0)
            ...
            try {
                return CheckHResult(Altaircam_writePtr(handle_, key, data.Length, handle.AddrOfPinnedObject()));
            }
            finally {
                handle.Free();
            }
    ...
    */
    ...
    public bool FfcExport(string filePath)
    {
        ...
        return CheckHResult(Altaircam_FfcExport(handle_, filePathHandle.Get()));
    }
    ...
    public bool FfcImport(string filePath)
    {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        StringHandle filePathHandle = new StringHandle(filePath);
        return CheckHResult(Altaircam_FfcImport(handle_, filePathHandle.Get()));
    }
    ...
    public bool DfcExport(string filePath)
    {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        StringHandle filePathHandle = new StringHandle(filePath);
        return CheckHResult(Altaircam_DfcExport(handle_, filePathHandle.Get()));
    }
    ...
    public bool DfcImport(string filePath)
    {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        StringHandle filePathHandle = new StringHandle(filePath);
        return CheckHResult(Altaircam_DfcImport(handle_, filePathHandle.Get()));
    }
    ...
    public bool FpncExport(string filePath)
    {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        StringHandle filePathHandle = new StringHandle(filePath);
        return CheckHResult(Altaircam_FpncExport(handle_, filePathHandle.Get()));
    }
    ...
    public bool FpncImport(string filePath)
    {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        StringHandle filePathHandle = new StringHandle(filePath);
        return CheckHResult(Altaircam_FpncImport(handle_, filePathHandle.Get()));
    }
    ...
    public static string query_Name(string camId)
    {
        ...
        IntPtr ptr = Marshal.AllocHGlobal(64);
        string str = string.Empty;
        if (Altaircam_get_Name(camIdHandle.Get(), ptr) >= 0)
            str = Marshal.PtrToStringAnsi(ptr);
        Marshal.FreeHGlobal(ptr);
        return str;
    }
    ...
    {
        StringHandle camIdHandle = new StringHandle(camId);
        return Altaircam_put_Name(camIdHandle.Get(), name);
    }
    ...
    public static string query_SerialNumber(string camId)
    {
        ...
        IntPtr ptr = Marshal.AllocHGlobal(32);
        string str = string.Empty;
        if (Altaircam_query_SerialNumber(camIdHandle.Get(), ptr) >= 0)
            str = Marshal.PtrToStringAnsi(ptr);
        Marshal.FreeHGlobal(ptr);
        return str;
    }
    ...
    */
    ...
    {
        StringHandle camIdHandle = new StringHandle(camId);
        return Altaircam_Replug(camIdHandle.Get());
    }
    ...
    */
    public static int Update(string camId, string filePath, DelegateProgress funProgress)
    {
        ...
        StringHandle camIdHandle = new StringHandle(camId);
        StringHandle filePathHandle = new StringHandle(filePath);
        int ret = Altaircam_Update(camIdHandle.Get(), filePathHandle.Get(), pProgress, id);
    ...
    */
...
#if NETCOREAPP
    private const string dll = "altaircam";
#elif LINUX
    private const string dll = "libaltaircam.so";
#else
    private const string dll = "altaircam.dll";
#endif
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern SafeCamHandle Altaircam_Open(IntPtr camId);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_PullImagePtr(SafeCamHandle h, int bStill, out ImagePtr ptrImage);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_WaitImagePtr(SafeCamHandle h, uint waitMS, int bStill, out ImagePtr ptrImage);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_PushImagePtr(SafeCamHandle h, uint ptrId);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_WaitImageV4(SafeCamHandle h, uint waitMS, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_WaitImageV4(SafeCamHandle h, uint waitMS, byte[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_WaitImageV4(SafeCamHandle h, uint waitMS, ushort[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV4 pInfo);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
    private static extern int Altaircam_WaitImageV3(SafeCamHandle h, uint waitMS, IntPtr pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
    private static extern int Altaircam_WaitImageV3(SafeCamHandle h, uint waitMS, byte[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
    private static extern int Altaircam_WaitImageV3(SafeCamHandle h, uint waitMS, ushort[] pImageData, int bStill, int bits, int rowPitch, out FrameInfoV3 pInfo);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_SnapV2(SafeCamHandle h, uint nResolutionIndex, uint nNumber, int eRGB, IntPtr snapCtx);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_Trigger(SafeCamHandle h, ushort nNumber);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_TriggerSyncV4(SafeCamHandle h, uint waitMS, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV4 pInfo);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_TriggerSyncV4(SafeCamHandle h, uint waitMS, byte[] pImageData, int bits, int rowPitch, out FrameInfoV4 pInfo);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_TriggerSyncV4(SafeCamHandle h, uint waitMS, ushort[] pImageData, int bits, int rowPitch, out FrameInfoV4 pInfo);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
    private static extern int Altaircam_TriggerSync(SafeCamHandle h, uint waitMS, IntPtr pImageData, int bits, int rowPitch, out FrameInfoV3 pInfo);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
    private static extern int Altaircam_TriggerSync(SafeCamHandle h, uint waitMS, byte[] pImageData, int bits, int rowPitch, out FrameInfoV3 pInfo);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete]
    private static extern int Altaircam_TriggerSync(SafeCamHandle h, uint waitMS, ushort[] pImageData, int bits, int rowPitch, out FrameInfoV3 pInfo);
    ...
    */
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_get_AutoExpoEnable(SafeCamHandle h, out int mode);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_put_AutoExpoEnable(SafeCamHandle h, int mode);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_query_Name(SafeCamHandle h, IntPtr name);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_set_Name(SafeCamHandle h, [MarshalAs(UnmanagedType.LPStr)] string name);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    ...
    */
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_get_PixelFormatBitdepth(ePIXELFORMAT val);
    ...
    */
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_readPtr(SafeCamHandle h, [MarshalAs(UnmanagedType.LPStr)] string key, int len, IntPtr pData);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_writePtr(SafeCamHandle h, [MarshalAs(UnmanagedType.LPStr)] string key, int len, IntPtr pData);
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_FfcExport(SafeCamHandle h, IntPtr filePath);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_FfcImport(SafeCamHandle h, IntPtr filePath);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_DfcExport(SafeCamHandle h, IntPtr filePath);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_DfcImport(SafeCamHandle h, IntPtr filePath);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_FpncExport(SafeCamHandle h, IntPtr filePath);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_FpncImport(SafeCamHandle h, IntPtr filePath);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_FfcFile(IntPtr[] data, uint num, uint width, uint height, uint fourcc, uint bits, [MarshalAs(UnmanagedType.LPStr)] string outfile);
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_put_AFMode(SafeCamHandle h, eAFMode mode, int bFixedWD, uint uiNear, uint uiFar);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_Replug(IntPtr camId);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_Update(IntPtr camId, IntPtr filePath, PROGRESS_CALLBACK funProgress, IntPtr ctxProgress);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_GigeEnable(HOTPLUG_CALLBACK funHotplug, IntPtr ctxHotplug);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_GigeEnableV2(HOTPLUG_CALLBACK funHotplug, IntPtr ctxHotplug, [MarshalAs(UnmanagedType.LPStr)] string opt);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_PciEnable(HOTPLUG_CALLBACK funHotplug, IntPtr ctxHotplug);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_CtiEnable(HOTPLUG_CALLBACK funHotplug, IntPtr ctxHotplug, IntPtr ctiPath);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_put_Name(IntPtr camId, [MarshalAs(UnmanagedType.LPStr)] string name);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_get_Name(IntPtr camId, IntPtr name);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Altaircam_query_SerialNumber(IntPtr camId, IntPtr sn);

    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern IntPtr Altaircam_get_Model(ushort idVendor, ushort idProduct);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern IntPtr Altaircam_query_Model(SafeCamHandle h);
    [DllImport(dll, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
