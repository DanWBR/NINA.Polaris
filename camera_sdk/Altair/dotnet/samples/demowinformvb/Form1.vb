...
Public Class Form1
    Private Delegate Sub DelegateEvent(evt As Altaircam.eEVENT())
    Private cam_ As Altaircam = Nothing
    ...
    Private Sub OnEventImage()
        If bmp_ IsNot Nothing Then
            Dim info As New Altaircam.FrameInfoV4
    ...
    Private Sub DelegateOnEvent(evt As Altaircam.eEVENT())
    ...
    Private Sub DelegateOnEventCallback(evt As Altaircam.eEVENT)
        ' this is called by internal thread of altaircam.dll which Is Not the same of UI thread.
        ' Why we use BeginInvoke, Please see:
        ' http//msdn.microsoft.com/en-us/magazine/cc300429.aspx
        ' http://msdn.microsoft.com/en-us/magazine/cc188732.aspx
        ' http://stackoverflow.com/questions/1364116/avoiding-the-woes-of-invoke-begininvoke-in-cross-thread-winform-event-handling
        BeginInvoke(ev_, New Altaircam.eEVENT() {evt})
    End Sub
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.trackBar2.SetRange(Altaircam.TEMP_MIN, Altaircam.TEMP_MAX)
        Me.trackBar3.SetRange(Altaircam.TINT_MIN, Altaircam.TINT_MAX)
    End Sub
    ...
    Private Sub OnStart(sender As Object, e As EventArgs) Handles button1.Click
        ...
        Dim arr As Altaircam.DeviceV2() = Altaircam.[EnumV2]()
        ...
        If cam_ IsNot Nothing Then
            ...
            If cam_.get_eSize(eSize) Then
                ...
                If cam_.get_Size(width, height) Then
                    ...
                    If Not cam_.StartPullModeWithCallback(New Altaircam.DelegateEventCallback(AddressOf Me.DelegateOnEventCallback)) Then
    ...
    Private Sub OnSelectResolution(sender As Object, e As EventArgs) Handles comboBox1.SelectedIndexChanged
        If cam_ IsNot Nothing Then
            Dim eSize As UInteger = 0
            If cam_.get_eSize(eSize) And eSize <> comboBox1.SelectedIndex Then
                cam_.[Stop]()
                ...
                If cam_.get_Size(width, height) Then
                    bmp_ = New Bitmap(width, height, PixelFormat.Format24bppRgb)
                    ev_ = New DelegateEvent(AddressOf Me.DelegateOnEvent)
                    cam_.StartPullModeWithCallback(New Altaircam.DelegateEventCallback(AddressOf Me.DelegateOnEventCallback))
                End If
            End If
        End If
    End Sub
    ...
    Private Sub pictureBox1_Paint(sender As Object, e As PaintEventArgs) Handles pictureBox1.Paint
        ...
        If (bmp_ IsNot Nothing) Then
            ...
            g.DrawString(label4.Text, Me.Font, SystemBrushes.ControlText, 0, 0)
        End If
    End Sub
End Class