...
/*
    ...
    We use JNA (https://github.com/java-native-access/jna) to call into the altaircam.dll/so/dylib API, the java class altaircam is a thin wrapper class to the native api.
    So the manual en.html(English) and hans.html(Simplified Chinese) are also applicable for programming with altaircam.java.
...
public class altaircam implements AutoCloseable {
    ...
    public final static long FLAG_40GIGE                  = 0x0001000000000000L;  /* 40 Gigabit GigE */
    ...
    public final static long FLAG_USB32                   = 0x0400000000000000L;  /* USB 3.2 Gen 2 */
    public final static long FLAG_USB32_OVER_USB30        = 0x0800000000000000L;  /* USB 3.2 Gen 2 camera connected to usb3.0 port */
    public final static long FLAG_LINESCAN                = 0x1000000000000000L;  /* line scan camera */
    public final static long FLAG_25GIGE                  = 0x2000000000000000L;  /* 2.5 Gigabit GigE */
    public final static long FLAG_RAW14PACK               = 0x4000000000000000L;  /* pixel format, RAW 14bits packed */
    ...
    public final static int OPTION_BLACKLEVEL             = 0x15;       /* [RW] the black level refers to the baseline signal value output by an image sensor under no-light (completely dark) conditions.
    ...
    public final static int OPTION_BINNING                = 0x17;       /* [RW] digital binning
                                                                               0x01: (no binning)
    ...
    public final static int OPTION_AFMODE                 = 0x25;       /* [RW] auto focus mode, see AltaircamAFMode */
    public final static int OPTION_AFSTATUS               = 0x27;       /* [RO] auto focus status, see AltaircamAFStaus */
    ...
    public final static int OPTION_CALLBACK_THREAD        = 0x30;       /* [RW] dedicated thread for callback: 0 => disable, 1 => enable
    ...
    public final static int OPTION_FPNC                   = 0x67;       /* [RW] Fix Pattern Noise Correction
                                                                                ...
                                                                                get:
                                                                                    ...
                                                                                    ((val & 0xff0000) >> 16): average number
                                                                        */
    public final static int OPTION_OVEREXP_POLICY          = 0x68;      /* [RW] Auto exposure overexposure policy: when overexposed,
    ...
    public final static int OPTION_CDS                    = 0x6e;       /* [RW] Correlated Double Sampling: 0~max (OPTION_CDS_MAX) */
    ...
    public final static int OPTION_GVCP_TIMEOUT           = 0x71;       /* [RW] GVCP Timeout: millisecond, range = [5, 150], default: 15(wire), 30(wireless)
                                                                             Unless in very special circumstances, generally no modification is required, just use the default value
                                                                        */
    public final static int OPTION_GVCP_RETRY             = 0x72;       /* [RW] GVCP Retry: range = [2, 16], default: 4(wire), 8(wireless)
                                                                             Unless in very special circumstances, generally no modification is required, just use the default value
                                                                        */
    ...
    public final static int OPTION_LANE                   = 0x7e;       /* [RW] Lane */
    ...
    public final static int OPTION_BLACKLEVEL_AUTOADJUST  = 0x89;       /* [RW] Black level automatic adjustment function: 0: off, 1: on
                                                                        ...
                                                                        */
    public final static int OPTION_USER_SET               = 0x8a;       /* [RW] user set */
    public final static int OPTION_DIGITAL_GAIN           = 0x1001;     /* [RW] digital gain */
    public final static int OPTION_ANTI_BLOOMING          = 0x8b;       /* [RW] Anti Blooming */
    public final static int OPTION_ANTI_BLOOMING_MAX      = 0x8c;       /* [RO] Anti Blooming */
    public final static int OPTION_CDS_MAX                = 0x8d;       /* [RO] Correlated Double Sampling */
    public final static int OPTION_SCANTYPE               = 0x8e;       /* [RW] Scan Type: 0(linescan), 1(areascan) */
    public final static int OPTION_OPERATIONMODE          = 0x8f;       /* [RW] TDI Operation Mode: 1(area), 2(TDI) */
    public final static int OPTION_TDITRIGGERMODE         = 0x90;       /* [RW] TDI Trigger Mode: 1(normal), 2(both) */
    public final static int OPTION_TDISTAGE               = 0x91;       /* [RW] TDI Trigger Stage: sensor scan stage */
    public final static int OPTION_FRAMEINTERVAL          = 0x92;       /* [RW] Frame Interval in microseconds */
    public final static int OPTION_FRAMEINTERVAL_MIN      = 0x93;       /* [RO] Frame Interval, minimum */
    public final static int OPTION_FRAMEINTERVAL_MAX      = 0x94;       /* [RO] Frame Interval, maximum */
    public final static int OPTION_IMAGEPTRRAW            = 0x95;       /* [RW] default: 0 */
    public final static int OPTION_IMAGEPTRBOTH           = 0x96;       /* [RW] default: 0 */
    ...
    public final static int PIXELFORMAT_RAW14PACK         = 0x14;
    ...
    public final static int ANTIBLOOMING_MIN          = 0;        /* Anti Blooming */
    public final static int GVCP_RETRY_DEF            = 4;        /* GVCP Retry */
    public final static int GVCP_RETRY_MIN            = 2;
    public final static int GVCP_RETRY_MAX            = 20;
    public final static int GVCP_TIMEOUT_DEF          = 40;       /* GVCP Timeout */
    public final static int GVCP_TIMEOUT_MIN          = 20;
    public final static int GVCP_TIMEOUT_MAX          = 200;
    public final static int GVSP_WAIT_PERCENT_DEF     = 1;        /* GVSP wait percent */
    public final static int GVSP_WAIT_PERCENT_MIN     = 0;
    public final static int GVSP_WAIT_PERCENT_MAX     = 100;
    public final static int FRONTEND_MAX              = 1024;     /* frontend frame buffer deque length */
    public final static int FRONTEND_DEF              = 4;
    public final static int FRONTEND_MIN              = 2;
    public final static int BACKEND_MAX               = 1024;     /* backend frame buffer deque length */
    public final static int BACKEND_DEF               = 3;
    public final static int BACKEND_MIN               = 2;
    ...
    /* flash zone */
    public final static int FLASH_SENSOR             = 0x00;    /* sensor */
    public final static int FLASH_USER               = 0x02;    /* user */
    ...
    public static class HRESULTException extends Exception {
        ...
        public final static int E_GEN_FAILURE   = 0x8007001f; /* Device not functioning */ /* Remark: It is generally caused by hardware errors, such as cable problems, USB port problems, poor contact, insufficient power supply, camera hardware damage, etc */
        ...
        public final static int E_UNREACH       = 0x80072743; /* Network is unreachable */ /* Remark: Please check the IP settings of the camera and the computer, or the firewall settings */
        public final static int E_CANCELLED     = 0x800704c7; /* The operation was canceled by the user */
    ...
    public static String PixelFormatName(int pixelFormat) {
        return _lib.Altaircam_get_PixelFormatName(pixelFormat);
    }

    public static int PixelFormatBitdepth(int pixelFormat) {
        return _lib.Altaircam_get_PixelFormatBitdepth(pixelFormat);
    }
    ...
    public static class ModelV2 {
        ...
        public int maxspeed;        /* number of speed level, same as Altaircam_get_MaxSpeed(), the speed range = [0, maxspeed], closed interval */
    ...
    @FieldOrder({ "id", "pixelFormat", "ergb", "snapR", "infoVer", "reserved", "strideRaw", "ptrInfo", "snapCtx", "ptrRaw", "ptr8", "ptr16" })
    public static class ImagePtr extends Structure {
        public int id;                /* 0 is reserved as an invalid id */
        public byte pixelFormat;      /* ALTAIRCAM_PIXELFORMAT_xxxx */
        public byte ergb;             /* see ALTAIRCAM_OPTION_RGB */
        public byte snapR;            /* see Altaircam_SnapR */
        public byte infoVer;          /* AltaircamFrameInfo version >= 4 */
        public int reserved;
        public int strideRaw;         /* stride of RAW, 0 means = image width (no padding) */
        public Pointer ptrInfo;
        public Pointer snapCtx;
        public Pointer ptrRaw;        /* RAW, see ALTAIRCAM_OPTION_IMAGEPTRRAW */
        public Pointer ptr8;
        public Pointer ptr16;
    }

    public static FrameInfoV3 Ptr2FrameInfoV3(Pointer ptrInfo) {
        FrameInfoV3 s = Structure.newInstance(FrameInfoV3.class, ptrInfo);
        s.read();
        return s;
    }

    public static FrameInfoV4 Ptr2FrameInfoV4(Pointer ptrInfo) {
        FrameInfoV4 s = Structure.newInstance(FrameInfoV4.class, ptrInfo);
        s.read();
        return s;
    }
    
    private interface CLib {
        Pointer Altaircam_Version();
        int Altaircam_EnumV2(Pointer ptr);
        int Altaircam_EnumWithName(Pointer ptr);
        Pointer Altaircam_OpenByIndex(int index);
        void Altaircam_Close(Pointer h);
        int Altaircam_PullImagePtr(Pointer h, int bStill, ImagePtr ptrImage);
        int Altaircam_PushImagePtr(Pointer h, int ptrId);
        int Altaircam_WaitImagePtr(Pointer h, int waitMS, int bStill, ImagePtr ptrImage);
        int Altaircam_PullImageV4(Pointer h, Pointer pImageData, int bStill, int bits, int rowPitch, FrameInfoV4 pInfo);
        int Altaircam_WaitImageV4(Pointer h, int waitMS, Pointer pImageData, int bStill, int bits, int rowPitch, FrameInfoV4 pInfo);
        @Deprecated int Altaircam_PullImageV3(Pointer h, Pointer pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo);
        @Deprecated int Altaircam_WaitImageV3(Pointer h, int waitMS, Pointer pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo);
        @Deprecated int Altaircam_PullImageV2(Pointer h, Pointer pImageData, int bits, FrameInfoV2 pInfo);
        @Deprecated int Altaircam_PullStillImageV2(Pointer h, Pointer pImageData, int bits, FrameInfoV2 pInfo);
        @Deprecated int Altaircam_PullImageWithRowPitchV2(Pointer h, Pointer pImageData, int bits, int rowPitch, FrameInfoV2 pInfo);
        @Deprecated int Altaircam_PullStillImageWithRowPitchV2(Pointer h, Pointer pImageData, int bits, int rowPitch, FrameInfoV2 pInfo);
        int Altaircam_Stop(Pointer h);
        int Altaircam_Pause(Pointer h, int bPause);
        int Altaircam_Snap(Pointer h, int nResolutionIndex);
        int Altaircam_SnapN(Pointer h, int nResolutionIndex, int nNumber);
        int Altaircam_SnapR(Pointer h, int nResolutionIndex, int nNumber);
        int Altaircam_SnapV2(Pointer h, int nResolutionIndex, int nNumber, int eRGB, Pointer snapCtx);
        int Altaircam_Trigger(Pointer h, short nNumber);
        int Altaircam_TriggerSyncV4(Pointer h, int waitMS, Pointer pImageData, int bits, int rowPitch, FrameInfoV4 pInfo);
        @Deprecated int Altaircam_TriggerSync(Pointer h, int waitMS, Pointer pImageData, int bits, int rowPitch, FrameInfoV3 pInfo);
        int Altaircam_put_Size(Pointer h, int nWidth, int nHeight);
        int Altaircam_get_Size(Pointer h, IntByReference nWidth, IntByReference nHeight);
        int Altaircam_put_eSize(Pointer h, int nResolutionIndex);
        int Altaircam_get_eSize(Pointer h, IntByReference nResolutionIndex);
        int Altaircam_get_FinalSize(Pointer h, IntByReference nWidth, IntByReference nHeight);
        int Altaircam_get_ResolutionNumber(Pointer h);
        int Altaircam_get_Resolution(Pointer h, int nResolutionIndex, IntByReference pWidth, IntByReference pHeight);
        int Altaircam_get_ResolutionRatio(Pointer h, int nResolutionIndex, IntByReference pNumerator, IntByReference pDenominator);
        int Altaircam_get_Field(Pointer h);
        int Altaircam_get_RawFormat(Pointer h, IntByReference nFourCC, IntByReference bitdepth);
        int Altaircam_put_RealTime(Pointer h, int val);
        int Altaircam_get_RealTime(Pointer h, IntByReference val);
        int Altaircam_Flush(Pointer h);
        int Altaircam_get_Temperature(Pointer h, ShortByReference pTemperature);
        int Altaircam_put_Temperature(Pointer h, short nTemperature);
        int Altaircam_get_Roi(Pointer h, IntByReference pxOffset, IntByReference pyOffset, IntByReference pxWidth, IntByReference pyHeight);
        int Altaircam_put_Roi(Pointer h, int xOffset, int yOffset, int xWidth, int yHeight);
        int Altaircam_put_RoiN(Pointer h, int[] xOffset, int[] yOffset, int[] xWidth, int[] yHeight, int Num);
        int Altaircam_put_XY(Pointer h, int x, int y);
        int Altaircam_get_AutoExpoEnable(Pointer h, IntByReference mode);
        int Altaircam_put_AutoExpoEnable(Pointer h, int mode);
        int Altaircam_get_AutoExpoTarget(Pointer h, ShortByReference Target);
        int Altaircam_put_AutoExpoTarget(Pointer h, short Target);
        int Altaircam_put_AutoExpoRange(Pointer h, int maxTime, int minTime, short maxGain, short minGain);
        int Altaircam_get_AutoExpoRange(Pointer h, IntByReference maxTime, IntByReference minTime, ShortByReference maxGain, ShortByReference minGain);
        int Altaircam_put_MaxAutoExpoTimeAGain(Pointer h, int maxTime, short maxGain);
        int Altaircam_get_MaxAutoExpoTimeAGain(Pointer h, IntByReference maxTime, ShortByReference maxGain);
        int Altaircam_put_MinAutoExpoTimeAGain(Pointer h, int minTime, short minGain);
        int Altaircam_get_MinAutoExpoTimeAGain(Pointer h, IntByReference minTime, ShortByReference minGain);
        int Altaircam_get_ExpoTime(Pointer h, IntByReference Time)/* in microseconds */;
        int Altaircam_put_ExpoTime(Pointer h, int Time)/* inmicroseconds */;
        int Altaircam_get_RealExpoTime(Pointer h, IntByReference Time); /* actual exposure time */
        int Altaircam_get_ExpTimeRange(Pointer h, IntByReference nMin, IntByReference nMax, IntByReference nDef);
        int Altaircam_get_ExpoAGain(Pointer h, ShortByReference Gain);/* percent, such as 300 */
        int Altaircam_put_ExpoAGain(Pointer h, short Gain);/* percent */
        int Altaircam_get_ExpoAGainRange(Pointer h, ShortByReference nMin, ShortByReference nMax, ShortByReference nDef);
        int Altaircam_put_LevelRange(Pointer h, short[] aLow, short[] aHigh);
        int Altaircam_get_LevelRange(Pointer h, short[] aLow, short[] aHigh);
        int Altaircam_put_LevelRangeV2(Pointer h, short mode, RECT pRoiRect, short[] aLow, short[] aHigh);
        int Altaircam_get_LevelRangeV2(Pointer h, ShortByReference pMode, RECT pRoiRect, short[] aLow, short[] aHigh);
        int Altaircam_put_Hue(Pointer h, int Hue);
        int Altaircam_get_Hue(Pointer h, IntByReference Hue);
        int Altaircam_put_Saturation(Pointer h, int Saturation);
        int Altaircam_get_Saturation(Pointer h, IntByReference Saturation);
        int Altaircam_put_Brightness(Pointer h, int Brightness);
        int Altaircam_get_Brightness(Pointer h, IntByReference Brightness);
        int Altaircam_get_Contrast(Pointer h, IntByReference Contrast);
        int Altaircam_put_Contrast(Pointer h, int Contrast);
        int Altaircam_get_Gamma(Pointer h, IntByReference Gamma);
        int Altaircam_put_Gamma(Pointer h, int Gamma);
        int Altaircam_get_Chrome(Pointer h, IntByReference bChrome);    /* monochromatic mode */
        int Altaircam_put_Chrome(Pointer h, int bChrome);
        int Altaircam_get_VFlip(Pointer h, IntByReference bVFlip);  /* vertical flip */
        int Altaircam_put_VFlip(Pointer h, int bVFlip);
        int Altaircam_get_HFlip(Pointer h, IntByReference bHFlip);
        int Altaircam_put_HFlip(Pointer h, int bHFlip);  /* horizontal flip */
        int Altaircam_get_Negative(Pointer h, IntByReference bNegative);
        int Altaircam_put_Negative(Pointer h, int bNegative);
        int Altaircam_put_Speed(Pointer h, short nSpeed);
        int Altaircam_get_Speed(Pointer h, ShortByReference pSpeed);
        int Altaircam_get_MaxSpeed(Pointer h);/* get the maximum speed, "Frame Speed Level", speed range = [0, max] */
        int Altaircam_get_MaxBitDepth(Pointer h);/* get the max bitdepth of this camera, such as 8, 10, 12, 14, 16 */
        int Altaircam_get_FanMaxSpeed(Pointer h);/* get the maximum fan speed, the fan speed range = [0, max], closed interval */
        int Altaircam_put_HZ(Pointer h, int nHZ);
        int Altaircam_get_HZ(Pointer h, IntByReference nHZ);
        int Altaircam_put_Mode(Pointer h, int bSkip); /* skip or bin */
        int Altaircam_get_Mode(Pointer h, IntByReference bSkip);
        int Altaircam_put_TempTint(Pointer h, int nTemp, int nTint);
        int Altaircam_get_TempTint(Pointer h, IntByReference nTemp, IntByReference nTint);
        int Altaircam_put_WhiteBalanceGain(Pointer h, int[] aGain);
        int Altaircam_get_WhiteBalanceGain(Pointer h, int[] aGain);
        int Altaircam_put_BlackBalance(Pointer h, short[] aSub);
        int Altaircam_get_BlackBalance(Pointer h, short[] aSub);
        int Altaircam_put_AWBAuxRect(Pointer h, RECT pAuxRect);
        int Altaircam_get_AWBAuxRect(Pointer h, RECT pAuxRect);
        int Altaircam_put_AEAuxRect(Pointer h, RECT pAuxRect);
        int Altaircam_get_AEAuxRect(Pointer h, RECT pAuxRect);
        int Altaircam_put_ABBAuxRect(Pointer h, RECT pAuxRect);
        int Altaircam_get_ABBAuxRect(Pointer h, RECT pAuxRect);
        int Altaircam_get_MonoMode(Pointer h);
        int Altaircam_get_StillResolutionNumber(Pointer h);
        int Altaircam_get_StillResolution(Pointer h, int nResolutionIndex, IntByReference pWidth, IntByReference pHeight);
        int Altaircam_get_Revision(Pointer h, ShortByReference pRevision);
        int Altaircam_get_SerialNumber(Pointer h, Pointer sn);
        int Altaircam_get_FwVersion(Pointer h, Pointer fwver);
        int Altaircam_get_HwVersion(Pointer h, Pointer hwver);
        int Altaircam_get_FpgaVersion(Pointer h, Pointer fpgaver);
        int Altaircam_get_ProductionDate(Pointer h, Pointer pdate);
        int Altaircam_get_PixelSize(Pointer h, int nResolutionIndex, FloatByReference x, FloatByReference y);
        int Altaircam_AwbOnce(Pointer h, Pointer funTT, Pointer ctxTT);
        int Altaircam_AwbInit(Pointer h, Pointer funWB, Pointer ctxWB);
        int Altaircam_LevelRangeAuto(Pointer h);
        int Altaircam_AbbOnce(Pointer h, Pointer funBB, Pointer ctxBB);
        int Altaircam_put_LEDState(Pointer h, short iLed, short iState, short iPeriod);
        int Altaircam_write_EEPROM(Pointer h, int addr, Pointer pBuffer, int nBufferLen);
        int Altaircam_read_EEPROM(Pointer h, int addr, Pointer pBuffer, int nBufferLen);
        int Altaircam_rwc_Flash(Pointer h, int action, int addr, int len, Pointer pData);
        int Altaircam_write_Pipe(Pointer h, int pipeId, Pointer pBuffer, int nBufferLen);
        int Altaircam_read_Pipe(Pointer h, int pipeId, Pointer pBuffer, int nBufferLen);
        int Altaircam_feed_Pipe(Pointer h, int pipeId);
        int Altaircam_write_UART(Pointer h, Pointer pBuffer, int nBufferLen);
        int Altaircam_read_UART(Pointer h, Pointer pBuffer, int nBufferLen);
        int Altaircam_put_Option(Pointer h, int iOption, int iValue);
        int Altaircam_get_Option(Pointer h, int iOption, IntByReference iValue);
        int Altaircam_get_PixelFormatSupport(Pointer h, byte cmd, IntByReference pixelFormat);
        String Altaircam_get_PixelFormatName(int val);
        int Altaircam_get_PixelFormatBitdepth(int val);
        /* Hardware Binning
         * Value: 1x1, 2x2, etc
         * Method: Average, Add
         */
        int Altaircam_put_Binning(Pointer h, String Value, String Method);
        int Altaircam_get_Binning(Pointer h, PointerByReference Value, PointerByReference Method);
        int Altaircam_get_BinningNumber(Pointer h);
        int Altaircam_get_BinningValue(Pointer h, int index, PointerByReference Value);
        int Altaircam_get_BinningMethod(Pointer h, int index, PointerByReference Value);
        int Altaircam_readPtr(Pointer h, String key, int len, Pointer pData);
        int Altaircam_writePtr(Pointer h, String key, int len, Pointer pData);
        int Altaircam_put_SelfTrigger(Pointer h, SelfTrigger pSt);
        int Altaircam_get_SelfTrigger(Pointer h, SelfTrigger pSt);
        int Altaircam_put_Linear(Pointer h, byte[] v8, short[] v16);
        int Altaircam_put_Curve(Pointer h, byte[] v8, short[] v16);
        int Altaircam_put_ColorMatrix(Pointer h, double[] v);
        int Altaircam_put_InitWBGain(Pointer h, short[] v);
        int Altaircam_get_FrameRate(Pointer h, IntByReference nFrame, IntByReference nTime, IntByReference nTotalFrame);
        int Altaircam_FfcOnce(Pointer h);
        int Altaircam_DfcOnce(Pointer h);
        int Altaircam_FpncOnce(Pointer h);
        int Altaircam_IoControl(Pointer h, int ioLine, int eType, int outVal, IntByReference inVal);
        int Altaircam_AAF(Pointer h, int action, int outVal, IntByReference inVal);
        int Altaircam_get_LensInfo(Pointer h, Pointer pInfo);
        int Altaircam_get_AFState(Pointer h, Pointer pState);
        int Altaircam_put_AFMode(Pointer h, int mode, int bFixedWD, int uiNear, int uiFar);
        int Altaircam_put_AFRoi(Pointer h, int xOffset, int yOffset, int xWidth, int yHeight);
        int Altaircam_put_AFAperture(Pointer h, int iAperture);
        int Altaircam_put_AFFMPos(Pointer h, int iFMPos);
        int Altaircam_get_FocusMotor(Pointer h, FocusMotor pFocusMotor);

        int Altaircam_TriggerSyncV4Array(Pointer h, int waitMS, byte[] pImageData, int bits, int rowPitch, FrameInfoV4 pInfo);
        int Altaircam_PullImageV4Array(Pointer h, byte[] pImageData, int bStill, int bits, int rowPitch, FrameInfoV4 pInfo);
        int Altaircam_WaitImageV4Array(Pointer h, int waitMS, byte[] pImageData, int bStill, int bits, int rowPitch, FrameInfoV4 pInfo);
        @Deprecated int Altaircam_TriggerSyncArray(Pointer h, int waitMS, byte[] pImageData, int bits, int rowPitch, FrameInfoV3 pInfo);
        @Deprecated int Altaircam_PullImageV3Array(Pointer h, byte[] pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo);
        @Deprecated int Altaircam_WaitImageV3Array(Pointer h, int waitMS, byte[] pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo);
        @Deprecated int Altaircam_PullImageV2Array(Pointer h, byte[] pImageData, int bits, FrameInfoV2 pInfo);
        @Deprecated int Altaircam_PullStillImageV2Array(Pointer h, byte[] pImageData, int bits, FrameInfoV2 pInfo);
        @Deprecated int Altaircam_PullImageWithRowPitchV2Array(Pointer h, byte[] pImageData, int bits, int rowPitch, FrameInfoV2 pInfo);
        @Deprecated int Altaircam_PullStillImageWithRowPitchV2Array(Pointer h, byte[] pImageData, int bits, int rowPitch, FrameInfoV2 pInfo);
        int Altaircam_write_EEPROMArray(Pointer h, int addr, byte[] pBuffer, int nBufferLen);
        int Altaircam_read_EEPROMArray(Pointer h, int addr, byte[] pBuffer, int nBufferLen);
        int Altaircam_rwc_FlashArray(Pointer h, int action, int addr, int len, byte[] pData);
        int Altaircam_write_PipeArray(Pointer h, int pipeId, byte[] pBuffer, int nBufferLen);
        int Altaircam_read_PipeArray(Pointer h, int pipeId, byte[] pBuffer, int nBufferLen);
        int Altaircam_write_UARTArray(Pointer h, byte[] pBuffer, int nBufferLen);
        int Altaircam_read_UARTArray(Pointer h, byte[] pBuffer, int nBufferLen);
        Pointer Altaircam_get_Model(short idVendor, short idProduct);
        int Altaircam_Gain2TempTint(int[] gain, IntByReference temp, IntByReference tint);
        void Altaircam_TempTint2Gain(int temp, int tint, int[] gain);
    }

    private interface WinLibrary extends CLib, StdCallLibrary {
        WinLibrary INSTANCE = (WinLibrary)Native.load("altaircam", WinLibrary.class, options_);
        
        interface EVENT_CALLBACK extends StdCallCallback {
            void invoke(int nEvent, Pointer ctxEvent);
        }
        
        Pointer Altaircam_Open(WString camId);
        int Altaircam_Replug(WString camId);
        int Altaircam_StartPullModeWithCallback(Pointer h, EVENT_CALLBACK funEvent, Pointer ctxEvent);
        int Altaircam_StartPullModeWithWndMsg(Pointer h, Pointer hWnd, int nMsg);
        int Altaircam_FfcImport(Pointer h, WString filePath);
        int Altaircam_FfcExport(Pointer h, WString filePath);
        int Altaircam_DfcImport(Pointer h, WString filePath);
        int Altaircam_DfcExport(Pointer h, WString filePath);
        int Altaircam_FpncImport(Pointer h, WString filePath);
        int Altaircam_FpncExport(Pointer h, WString filePath);
        ...
        int Altaircam_Update(WString camId, WString filePath, PROGRESS_CALLBACK funProgress, Pointer ctxProgress);
        int Altaircam_GigeEnable(HOTPLUG_CALLBACK funHotplug, Pointer ctxHotplug);
        int Altaircam_GigeEnableV2(HOTPLUG_CALLBACK funHotplug, Pointer ctxHotplug, String opt);
        int Altaircam_PciEnable(HOTPLUG_CALLBACK funHotplug, Pointer ctxHotplug);
        int Altaircam_CtiEnable(HOTPLUG_CALLBACK funHotplug, Pointer ctxHotplug, WString[] ctiPath);

        interface HISTOGRAM_CALLBACK extends StdCallCallback {
            void invoke(Pointer aHist, int nFlag, Pointer ctxHistogram);
        }
        int Altaircam_GetHistogramV2(Pointer h, HISTOGRAM_CALLBACK funHistogram, Pointer ctxHistogram);
    }
    
    private interface CLibrary extends CLib, Library {
        CLibrary INSTANCE = (CLibrary)Native.load("altaircam", CLibrary.class, options_);
        
        interface EVENT_CALLBACK extends Callback {
            void invoke(int nEvent, Pointer ctxEvent);
        }
        
        Pointer Altaircam_Open(String camId);
        int Altaircam_Replug(String camId);
        int Altaircam_StartPullModeWithCallback(Pointer h, EVENT_CALLBACK funEvent, Pointer ctxEvent);
        int Altaircam_FfcImport(Pointer h, String filePath);
        int Altaircam_FfcExport(Pointer h, String filePath);
        int Altaircam_DfcImport(Pointer h, String filePath);
        int Altaircam_DfcExport(Pointer h, String filePath);
        int Altaircam_FpncImport(Pointer h, String filePath);
        int Altaircam_FpncExport(Pointer h, String filePath);
        
        interface HOTPLUG_CALLBACK extends Callback {
            void invoke(Pointer ctxHotPlug);
        }
        void Altaircam_HotPlug(HOTPLUG_CALLBACK funHotPlug, Pointer ctxHotPlug);

        interface PROGRESS_CALLBACK extends Callback {
            void invoke(int percent, Pointer ctxProgress);
        }
        int Altaircam_Update(String camId, String filePath, PROGRESS_CALLBACK funProgress, Pointer ctxProgress);
        int Altaircam_GigeEnable(HOTPLUG_CALLBACK funHotplug, Pointer ctxHotplug);
        int Altaircam_GigeEnableV2(HOTPLUG_CALLBACK funHotplug, Pointer ctxHotplug, String opt);
        int Altaircam_PciEnable(HOTPLUG_CALLBACK funHotplug, Pointer ctxHotplug);
        int Altaircam_CtiEnable(HOTPLUG_CALLBACK funHotplug, Pointer ctxHotplug, String[] ctiPath);
    ...
    private final static Map options_ = new HashMap() {
        {
            put(Library.OPTION_FUNCTION_MAPPER, new FunctionMapper() {
                HashMap<String, String> funcmap_ = new HashMap() {
                    {
                        put("Altaircam_TriggerSyncV4Array", "Altaircam_TriggerSyncV4");
                        put("Altaircam_PullImageV4Array", "Altaircam_PullImageV4");
                        put("Altaircam_WaitImageV4Array", "Altaircam_WaitImageV4");
                        put("Altaircam_TriggerSyncArray", "Altaircam_TriggerSync");
                        put("Altaircam_PullImageV3Array", "Altaircam_PullImageV3");
                        put("Altaircam_WaitImageV3Array", "Altaircam_WaitImageV3");
                        put("Altaircam_PullImageV2Array", "Altaircam_PullImageV2");
                        put("Altaircam_PullStillImageV2Array", "Altaircam_PullStillImageV2");
                        put("Altaircam_PullImageWithRowPitchV2Array", "Altaircam_PullImageWithRowPitchV2");
                        put("Altaircam_PullStillImageWithRowPitchV2Array", "Altaircam_PullStillImageWithRowPitchV2");
                        put("Altaircam_write_EEPROMArray", "Altaircam_write_EEPROM");
                        put("Altaircam_read_EEPROMArray", "Altaircam_read_EEPROM");
                        put("Altaircam_rwc_FlashArray", "Altaircam_rwcFlash");
                        put("Altaircam_write_PipeArray", "Altaircam_write_Pipe");
                        put("Altaircam_read_PipeArray", "Altaircam_read_Pipe");
                        put("Altaircam_write_UARTArray", "Altaircam_write_UART");
                        put("Altaircam_read_UARTArray", "Altaircam_read_UART");
                    }
                };
    ...
    private final static Map<Integer, Object> _hash = new HashMap<>();
    ...
    */
    ...
    /* get the version of this dll/so/dylib, which is: 60.31589.20260531 */
    public static String Version() {
        if (Platform.isWindows())
            return _lib.Altaircam_Version().getWideString(0);
        else
            return _lib.Altaircam_Version().getString(0);
    }
    ...
    */
    public static void HotPlug(IHotplugCallback cb) throws HRESULTException {
        ...
        else
        {
            ...
            ((CLibrary)_lib).Altaircam_HotPlug(_hotplugcallback, new Pointer(0));
        }
    }
    ...
    public static DeviceV2[] EnumV2() {
        ...
        return Ptr2Device(ptr, _lib.Altaircam_EnumV2(ptr));
    }
    
    public static DeviceV2[] EnumWithName() {
        Memory ptr = new Memory(512 * 128);
        return Ptr2Device(ptr, _lib.Altaircam_EnumWithName(ptr));
    }

    private static void OnHotplugCallback(Pointer ctxHotplug) {
        Object o = null;
        synchronized (_hash) {
            o = _hash.get((int)Pointer.nativeValue(ctxHotplug));
        }
    ...
    */
    public static void GigeEnable(IHotplugCallback cb, String opt) throws HRESULTException {
        int id;
        synchronized (_hash) {
            id = _clsid++;
            _hash.put(id, cb);
        ...
        if (Platform.isWindows()) {
            ...
            if ((opt == null) || (opt.isEmpty()))
                errCheck(((WinLibrary)_lib).Altaircam_GigeEnable(p, new Pointer(id)));
            else
                errCheck(((WinLibrary)_lib).Altaircam_GigeEnableV2(p, new Pointer(id), opt));
        }
        else {
            ...
            Native.setCallbackThreadInitializer(p, new CallbackThreadInitializer(false, false, "hotplugCallback"));
            if ((opt == null) || (opt.isEmpty()))
                errCheck(((CLibrary)_lib).Altaircam_GigeEnable(p, new Pointer(id)));
            else
                errCheck(((CLibrary)_lib).Altaircam_GigeEnableV2(p, new Pointer(id), opt));
        }
    }
    ...
    public static void PciEnable(IHotplugCallback cb) throws HRESULTException {
        ...
        if (Platform.isWindows()) {
            ...
            Native.setCallbackThreadInitializer(p, new CallbackThreadInitializer(false, false, "hotplugCallback"));
            errCheck(((WinLibrary)_lib).Altaircam_PciEnable(p, new Pointer(id)));
        }
        else {
            CLibrary.HOTPLUG_CALLBACK p = new CLibrary.HOTPLUG_CALLBACK() {
                @Override
            ...
            Native.setCallbackThreadInitializer(p, new CallbackThreadInitializer(false, false, "hotplugCallback"));
            errCheck(((CLibrary)_lib).Altaircam_PciEnable(p, new Pointer(id)));
        }
    }
    ...
    */
    public static void CtiEnable(IHotplugCallback cb, String[] ctiPath) throws HRESULTException {
        ...
        if (Platform.isWindows()) {
            WString[] newPath = new WString[ctiPath.length + 1]; /* Use NULL pointer to indicate the end of the array */
            ...
            Native.setCallbackThreadInitializer(p, new CallbackThreadInitializer(false, false, "hotplugCallback"));
            errCheck(((WinLibrary)_lib).Altaircam_CtiEnable(p, new Pointer(id), newPath));
        }
        else {
            ...
            Native.setCallbackThreadInitializer(p, new CallbackThreadInitializer(false, false, "hotplugCallback"));
            errCheck(((CLibrary)_lib).Altaircam_CtiEnable(p, new Pointer(id), newPath));
        }
    }
    ...
    */
    ...
    public static altaircam Open(String camId) {
        ...
        if (Platform.isWindows()) {
            if (camId == null)
                tmphandle = ((WinLibrary)_lib).Altaircam_Open(null);
            else
                tmphandle = ((WinLibrary)_lib).Altaircam_Open(new WString(camId));
        }
        else {
            tmphandle = ((CLibrary)_lib).Altaircam_Open(camId);
        }
        if (tmphandle == null)
            return null;
    ...
    */
    /*
        ...
        etc
    */
    public static altaircam OpenByIndex(int index) {
        Pointer tmphandle = _lib.Altaircam_OpenByIndex(index);
        if (tmphandle == null)
            return null;
        return new altaircam(tmphandle);
    }
    ...
    public int getResolutionNumber() throws HRESULTException {
        return errCheck(_lib.Altaircam_get_ResolutionNumber(_handle));
    }
    
    public int getStillResolutionNumber() throws HRESULTException {
        return errCheck(_lib.Altaircam_get_StillResolutionNumber(_handle));
    }
    ...
    */
    public boolean getMonoMode() throws HRESULTException {
        return (0 == errCheck(_lib.Altaircam_get_MonoMode(_handle)));
    }
    
    /* get the maximum speed, "Frame Speed Level" */
    public int getMaxSpeed() throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Altaircam_get_MaxSpeed(_handle));
        return p.getValue();
    }
    ...
    public String getSerialNumber() throws HRESULTException {
        ...
        errCheck(_lib.Altaircam_get_SerialNumber(_handle, p));
    ...
    public String getFwVersion() throws HRESULTException {
        ...
        errCheck(_lib.Altaircam_get_FwVersion(_handle, p));
        return p.getString(0);
    }
    ...
    public String getHwVersion() throws HRESULTException {
        Memory p = new Memory(16);
        errCheck(_lib.Altaircam_get_HwVersion(_handle, p));
        return p.getString(0);
    }
    ...
    public String getProductionDate() throws HRESULTException {
        Memory p = new Memory(16);
        errCheck(_lib.Altaircam_get_ProductionDate(_handle, p));
        return p.getString(0);
    }
    ...
    public String getFpgaVersion() throws HRESULTException {
        Memory p = new Memory(16);
        errCheck(_lib.Altaircam_get_FpgaVersion(_handle, p));
        return p.getString(0);
    }
    
    public int getField() throws HRESULTException {
        return errCheck(_lib.Altaircam_get_Field(_handle));
    }
    
    private static void OnEventCallback(int nEvent, Pointer ctxEvent) {
        Object o = null;
        synchronized (_hash) {
            o = _hash.get((int)Pointer.nativeValue(ctxEvent));
        }
        if (o instanceof altaircam) {
            altaircam t = (altaircam)o;
            if (t._cb != null)
    ...
    public void StartPullModeWithCallback(IEventCallback cb) throws HRESULTException {
        ...
        if (Platform.isWindows()) {
            ...
            errCheck(((WinLibrary)_lib).Altaircam_StartPullModeWithCallback(_handle, (WinLibrary.EVENT_CALLBACK)_callback, new Pointer(_objid)));
        }
        else {
            ...
            Native.setCallbackThreadInitializer(_callback, new CallbackThreadInitializer(false, false, "eventCallback"));
            errCheck(((CLibrary)_lib).Altaircam_StartPullModeWithCallback(_handle, (CLibrary.EVENT_CALLBACK)_callback, new Pointer(_objid)));
        }
    }

    public void StartPullModeWithWndMsg(Pointer hWnd, int nMsg) throws HRESULTException {
        if (Platform.isWindows())
            errCheck(((WinLibrary)_lib).Altaircam_StartPullModeWithWndMsg(_handle, hWnd, nMsg));
        else
            errCheck(HRESULTException.E_NOTIMPL);
    }
    ...
    public void PullImagePtr(int bStill, ImagePtr ptrImage) throws HRESULTException {
        errCheck(_lib.Altaircam_PullImagePtr(_handle, bStill, ptrImage));
    }
    ...
    */
    public void PushImagePtr(int ptrId) throws HRESULTException {
        errCheck(_lib.Altaircam_PushImagePtr(_handle, ptrId));
    }
    ...
    */
    public void WaitImagePtr(int waitMS, int bStill, ImagePtr ptrImage) throws HRESULTException {
        errCheck(_lib.Altaircam_WaitImagePtr(_handle, waitMS, bStill, ptrImage));
    }

    @Deprecated
    public void PullImageV2(ByteBuffer pImageData, int bits, FrameInfoV2 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Altaircam_PullImageV2(_handle, Native.getDirectBufferPointer(pImageData), bits, pInfo));
    ...
    public void PullImageV2(byte[] pImageData, int bits, FrameInfoV2 pInfo) throws HRESULTException {
        errCheck(_lib.Altaircam_PullImageV2Array(_handle, pImageData, bits, pInfo));
    }

    @Deprecated
    public void PullStillImageV2(ByteBuffer pImageData, int bits, FrameInfoV2 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Altaircam_PullStillImageV2(_handle, Native.getDirectBufferPointer(pImageData), bits, pInfo));
        else if (pImageData.hasArray())
    ...
    public void PullStillImageV2(byte[] pImageData, int bits, FrameInfoV2 pInfo) throws HRESULTException {
        errCheck(_lib.Altaircam_PullStillImageV2Array(_handle, pImageData, bits, pInfo));
    }
    ...
    */
    public void PullImage(ByteBuffer pImageData, int bStill, int bits, int rowPitch, FrameInfoV4 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Altaircam_PullImageV4(_handle, Native.getDirectBufferPointer(pImageData), bStill, bits, rowPitch, pInfo));
        else if (pImageData.hasArray())
    ...
    public void PullImage(byte[] pImageData, int bStill, int bits, int rowPitch, FrameInfoV4 pInfo) throws HRESULTException {
        errCheck(_lib.Altaircam_PullImageV4Array(_handle, pImageData, bStill, bits, rowPitch, pInfo));
    }

    @Deprecated
    public void PullImageV3(ByteBuffer pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Altaircam_PullImageV3(_handle, Native.getDirectBufferPointer(pImageData), bStill, bits, rowPitch, pInfo));
        else if (pImageData.hasArray())
    ...
    public void PullImageV3(byte[] pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo) throws HRESULTException {
        errCheck(_lib.Altaircam_PullImageV3Array(_handle, pImageData, bStill, bits, rowPitch, pInfo));
    }

    public void WaitImage(int waitMS, ByteBuffer pImageData, int bStill, int bits, int rowPitch, FrameInfoV4 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Altaircam_WaitImageV4(_handle, waitMS, Native.getDirectBufferPointer(pImageData), bStill, bits, rowPitch, pInfo));
        else if (pImageData.hasArray())
            WaitImage(waitMS, pImageData.array(), bStill, bits, rowPitch, pInfo);
        else
            errCheck(HRESULTException.E_INVALIDARG);
    }

    public void WaitImage(int waitMS, byte[] pImageData, int bStill, int bits, int rowPitch, FrameInfoV4 pInfo) throws HRESULTException {
        errCheck(_lib.Altaircam_WaitImageV4Array(_handle, waitMS, pImageData, bStill, bits, rowPitch, pInfo));
    }

    @Deprecated
    public void WaitImageV3(int waitMS, ByteBuffer pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Altaircam_WaitImageV3(_handle, waitMS, Native.getDirectBufferPointer(pImageData), bStill, bits, rowPitch, pInfo));
        else if (pImageData.hasArray())
            WaitImageV3(waitMS, pImageData.array(), bStill, bits, rowPitch, pInfo);
        else
            errCheck(HRESULTException.E_INVALIDARG);
    }

    @Deprecated
    public void WaitImageV3(int waitMS, byte[] pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo) throws HRESULTException {
        errCheck(_lib.Altaircam_WaitImageV3Array(_handle, waitMS, pImageData, bStill, bits, rowPitch, pInfo));
    }
    ...
    public void PullImageWithRowPitchV2(ByteBuffer pImageData, int bits, int rowPitch, FrameInfoV2 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Altaircam_PullImageWithRowPitchV2(_handle, Native.getDirectBufferPointer(pImageData), bits, rowPitch, pInfo));
        else if (pImageData.hasArray())
    ...
    public void PullImageWithRowPitchV2(byte[] pImageData, int bits, int rowPitch, FrameInfoV2 pInfo) throws HRESULTException {
        errCheck(_lib.Altaircam_PullImageWithRowPitchV2Array(_handle, pImageData, bits, rowPitch, pInfo));
    }
    ...
    public void PullStillImageWithRowPitchV2(ByteBuffer pImageData, int bits, int rowPitch, FrameInfoV2 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Altaircam_PullStillImageWithRowPitchV2(_handle, Native.getDirectBufferPointer(pImageData), bits, rowPitch, pInfo));
        else if (pImageData.hasArray())
    ...
    public void PullStillImageWithRowPitchV2(byte[] pImageData, int bits, int rowPitch, FrameInfoV2 pInfo) throws HRESULTException {
        errCheck(_lib.Altaircam_PullStillImageWithRowPitchV2Array(_handle, pImageData, bits, rowPitch, pInfo));
    }
    
    public void Stop() throws HRESULTException {
        errCheck(_lib.Altaircam_Stop(_handle));
    ...
    public void Pause(boolean bPause) throws HRESULTException {
        errCheck(_lib.Altaircam_Pause(_handle, bPause ? 1 : 0));
    }
    ...
    public void Snap(int nResolutionIndex) throws HRESULTException {
        errCheck(_lib.Altaircam_Snap(_handle, nResolutionIndex));
    }
    ...
    public void SnapN(int nResolutionIndex, int nNumber) throws HRESULTException {
        errCheck(_lib.Altaircam_SnapN(_handle, nResolutionIndex, nNumber));
    }
    ...
    public void SnapR(int nResolutionIndex, int nNumber) throws HRESULTException {
        errCheck(_lib.Altaircam_SnapR(_handle, nResolutionIndex, nNumber));
    }

    public void SnapV2(int nResolutionIndex, int nNumber, int eRGB) throws HRESULTException {
        errCheck(_lib.Altaircam_SnapV2(_handle, nResolutionIndex, nNumber, eRGB, Pointer.NULL));
    }
    ...
    */
    public void Trigger(short nNumber) throws HRESULTException {
        errCheck(_lib.Altaircam_Trigger(_handle, nNumber));
    }
    ...
    */
    public void TriggerSync(int waitMS, ByteBuffer pImageData, int bits, int rowPitch, FrameInfoV3 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Altaircam_TriggerSync(_handle, waitMS, Native.getDirectBufferPointer(pImageData), bits, rowPitch, pInfo));
        else if (pImageData.hasArray())
            TriggerSync(waitMS, pImageData.array(), bits, rowPitch, pInfo);
        else
            errCheck(HRESULTException.E_INVALIDARG);
    }

    public void TriggerSync(int waitMS, byte[] pImageData, int bits, int rowPitch, FrameInfoV4 pInfo) throws HRESULTException {
        errCheck(_lib.Altaircam_TriggerSyncV4Array(_handle, waitMS, pImageData, bits, rowPitch, pInfo));
    }

    @Deprecated
    public void TriggerSync(int waitMS, ByteBuffer pImageData, int bits, int rowPitch, FrameInfoV4 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Altaircam_TriggerSyncV4(_handle, waitMS, Native.getDirectBufferPointer(pImageData), bits, rowPitch, pInfo));
        else if (pImageData.hasArray())
            TriggerSync(waitMS, pImageData.array(), bits, rowPitch, pInfo);
        else
            errCheck(HRESULTException.E_INVALIDARG);
    ...
    @Deprecated
    public void TriggerSync(int waitMS, byte[] pImageData, int bits, int rowPitch, FrameInfoV3 pInfo) throws HRESULTException {
        errCheck(_lib.Altaircam_TriggerSyncArray(_handle, waitMS, pImageData, bits, rowPitch, pInfo));
    }
    
    public void put_Size(int nWidth, int nHeight) throws HRESULTException {
        errCheck(_lib.Altaircam_put_Size(_handle, nWidth, nHeight));
    }
    ...
    public int[] get_Size() throws HRESULTException {
        ...
        errCheck(_lib.Altaircam_get_Size(_handle, p, q));
    ...
    */
    public void put_eSize(int nResolutionIndex) throws HRESULTException {
        errCheck(_lib.Altaircam_put_eSize(_handle, nResolutionIndex));
    }
    
    public int get_eSize() throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Altaircam_get_eSize(_handle, p));
        return p.getValue();
    }
    ...
    */
    public int[] get_FinalSize() throws HRESULTException {
        IntByReference p = new IntByReference();
        IntByReference q = new IntByReference();
        errCheck(_lib.Altaircam_get_FinalSize(_handle, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    ...
    public int[] get_Resolution(int nResolutionIndex) throws HRESULTException {
        IntByReference p = new IntByReference();
        IntByReference q = new IntByReference();
        errCheck(_lib.Altaircam_get_Resolution(_handle, nResolutionIndex, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    ...
    */
    public float[] get_PixelSize(int nResolutionIndex) throws HRESULTException {
        ...
        errCheck(_lib.Altaircam_get_PixelSize(_handle, nResolutionIndex, p, q));
    ...
    */
    public int[] get_ResolutionRatio(int nResolutionIndex) throws HRESULTException {
        IntByReference p = new IntByReference();
        IntByReference q = new IntByReference();
        errCheck(_lib.Altaircam_get_ResolutionRatio(_handle, nResolutionIndex, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    ...
    */
    public int[] get_RawFormat() throws HRESULTException {
        IntByReference p = new IntByReference();
        IntByReference q = new IntByReference();
        errCheck(_lib.Altaircam_get_RawFormat(_handle, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    ...
    */
    public int get_AutoExpoEnable() throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Altaircam_get_AutoExpoEnable(_handle, p));
        return p.getValue();
    }
    
    public void put_AutoExpoEnable(int mode) throws HRESULTException {
        errCheck(_lib.Altaircam_put_AutoExpoEnable(_handle, mode));
    }
    
    public short get_AutoExpoTarget() throws HRESULTException {
        ShortByReference p = new ShortByReference();
        errCheck(_lib.Altaircam_get_AutoExpoTarget(_handle, p));
        return p.getValue();
    }
    
    public void put_AutoExpoTarget(short Target) throws HRESULTException {
        errCheck(_lib.Altaircam_put_AutoExpoTarget(_handle, Target));
    }
    
    public void put_AutoExpoRange(int maxTime, int minTime, short maxGain, short minGain) throws HRESULTException {
        errCheck(_lib.Altaircam_put_AutoExpoRange(_handle, maxTime, minTime, maxGain, minGain));
    }
    ...
    public int[] get_AutoExpoRange() throws HRESULTException {
        ...
        errCheck(_lib.Altaircam_get_AutoExpoRange(_handle, maxTime, minTime, maxGain, minGain));
    ...
    public void put_MaxAutoExpoTimeAGain(int maxTime, short maxGain) throws HRESULTException {
        errCheck(_lib.Altaircam_put_MaxAutoExpoTimeAGain(_handle, maxTime, maxGain));
    }
    
    public int[] get_MaxAutoExpoTimeAGain() throws HRESULTException {
        IntByReference p = new IntByReference();
        ShortByReference q = new ShortByReference();
        errCheck(_lib.Altaircam_get_MaxAutoExpoTimeAGain(_handle, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    
    public void put_MinAutoExpoTimeAGain(int minTime, short minGain) throws HRESULTException {
        errCheck(_lib.Altaircam_put_MinAutoExpoTimeAGain(_handle, minTime, minGain));
    }
    
    public int[] get_MinAutoExpoTimeAGain() throws HRESULTException {
        IntByReference p = new IntByReference();
        ShortByReference q = new ShortByReference();
        errCheck(_lib.Altaircam_get_MinAutoExpoTimeAGain(_handle, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    ...
    public int get_ExpoTime() throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Altaircam_get_ExpoTime(_handle, p));
        return p.getValue();
    }
    ...
    public int get_RealExpoTime() throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Altaircam_get_RealExpoTime(_handle, p));
        return p.getValue();
    }
    
    /* in microseconds */
    public void put_ExpoTime(int Time) throws HRESULTException {
        errCheck(_lib.Altaircam_put_ExpoTime(_handle, Time));
    }
    ...
    public int[] get_ExpTimeRange() throws HRESULTException {
        ...
        errCheck(_lib.Altaircam_get_ExpTimeRange(_handle, p, q, r));
    ...
    public short get_ExpoAGain() throws HRESULTException{
        ShortByReference p = new ShortByReference();
        errCheck(_lib.Altaircam_get_ExpoAGain(_handle, p));
        return p.getValue();
    }
    
    /* percent */
    public void put_ExpoAGain(short Gain) throws HRESULTException {
        errCheck(_lib.Altaircam_put_ExpoAGain(_handle, Gain));
    }
    ...
    public short[] get_ExpoAGainRange() throws HRESULTException {
        ...
        errCheck(_lib.Altaircam_get_ExpoAGainRange(_handle, p, q, r));
    ...
    public void put_LevelRange(short[] aLow, short[] aHigh) throws HRESULTException {
        if (aLow.length != 4 || aHigh.length != 4)
            errCheck(HRESULTException.E_INVALIDARG);
        errCheck(_lib.Altaircam_put_LevelRange(_handle, aLow, aHigh));
    }
    
    public void get_LevelRange(short[] aLow, short[] aHigh) throws HRESULTException {
        if (aLow.length != 4 || aHigh.length != 4)
            errCheck(HRESULTException.E_INVALIDARG);
        errCheck(_lib.Altaircam_get_LevelRange(_handle, aLow, aHigh));
    }
    ...
    public void put_LevelRangeV2(short mode, int roiX, int roiY, int roiWidth, int roiHeight, short[] aLow, short[] aHigh) throws HRESULTException {
        ...
        errCheck(_lib.Altaircam_put_LevelRangeV2(_handle, mode, rc, aLow, aHigh));
    }
    ...
    public int[] get_LevelRangeV2(short[] aLow, short[] aHigh) throws HRESULTException {
        ...
        RECT rc = new RECT();
        errCheck(_lib.Altaircam_get_LevelRangeV2(_handle, pMode, rc, aLow, aHigh));
    ...
    */
    public void put_HZ(int nHZ) throws HRESULTException {
        errCheck(_lib.Altaircam_put_HZ(_handle, nHZ));
    }
    
    public int get_HZ() throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Altaircam_get_HZ(_handle, p));
        return p.getValue();
    }
    
    /* skip or bin */
    public void put_Mode(boolean bSkip) throws HRESULTException {
        errCheck(_lib.Altaircam_put_Mode(_handle, bSkip ? 1 : 0));
    }
    
    public boolean get_Mode() throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Altaircam_get_Mode(_handle, p));
        return (p.getValue() != 0);
    }
    
    /* White Balance, Temp/Tint mode */
    public void put_TempTint(int nTemp, int nTint) throws HRESULTException {
        errCheck(_lib.Altaircam_put_TempTint(_handle, nTemp, nTint));
    }
    ...
    public int[] get_TempTint() throws HRESULTException {
        IntByReference p = new IntByReference();
        IntByReference q = new IntByReference();
        errCheck(_lib.Altaircam_get_TempTint(_handle, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    ...
    public void put_WhiteBalanceGain(int[] aGain) throws HRESULTException {
        if (aGain.length != 3)
            errCheck(HRESULTException.E_INVALIDARG);
        errCheck(_lib.Altaircam_put_WhiteBalanceGain(_handle, aGain));
    }
    ...
    public void get_WhiteBalanceGain(int[] aGain) throws HRESULTException {
        if (aGain.length != 3)
            errCheck(HRESULTException.E_INVALIDARG);
        errCheck(_lib.Altaircam_get_WhiteBalanceGain(_handle, aGain));
    }
    ...
    public void put_AWBAuxRect(int X, int Y, int Width, int Height) throws HRESULTException {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        errCheck(_lib.Altaircam_put_AWBAuxRect(_handle, rc));
    }
    
    /* left, top, width, height */
    public int[] get_AWBAuxRect() throws HRESULTException {
        RECT rc = new RECT();
        errCheck(_lib.Altaircam_get_AWBAuxRect(_handle, rc));
    ...
    public void put_AEAuxRect(int X, int Y, int Width, int Height) throws HRESULTException {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        errCheck(_lib.Altaircam_put_AEAuxRect(_handle, rc));
    }
    
    /* left, top, width, height */
    public int[] get_AEAuxRect() throws HRESULTException {
        RECT rc = new RECT();
        errCheck(_lib.Altaircam_get_AEAuxRect(_handle, rc));
        return new int[] { rc.left, rc.top, rc.right - rc.left, rc.bottom - rc.top };
    }
    ...
    public void put_BlackBalance(short[] aSub) throws HRESULTException {
        if (aSub.length != 3)
            errCheck(HRESULTException.E_INVALIDARG);
        errCheck(_lib.Altaircam_put_BlackBalance(_handle, aSub));
    }
    
    public short[] get_BlackBalance() throws HRESULTException {
        short[] p = new short[3];
        errCheck(_lib.Altaircam_get_BlackBalance(_handle, p));
        return p;
    }
    ...
    public void put_ABBAuxRect(int X, int Y, int Width, int Height) throws HRESULTException {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        errCheck(_lib.Altaircam_put_ABBAuxRect(_handle, rc));
    }
    
    /* left, top, width, height */
    public int[] get_ABBAuxRect() throws HRESULTException {
        RECT rc = new RECT();
        errCheck(_lib.Altaircam_get_ABBAuxRect(_handle, rc));
        return new int[] { rc.left, rc.top, rc.right - rc.left, rc.bottom - rc.top };
    }
    ...
    public int[] get_StillResolution(int nResolutionIndex) throws HRESULTException {
        IntByReference p = new IntByReference();
        IntByReference q = new IntByReference();
        errCheck(_lib.Altaircam_get_StillResolution(_handle, nResolutionIndex, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    ...
    */
    public void put_LEDState(short iLed, short iState, short iPeriod) throws HRESULTException {
        errCheck(_lib.Altaircam_put_LEDState(_handle, iLed, iState, iPeriod));
    }
    
    public void write_EEPROM(int addr, ByteBuffer pBuffer) throws HRESULTException {
        if (pBuffer.isDirect())
            errCheck(_lib.Altaircam_write_EEPROM(_handle, addr, Native.getDirectBufferPointer(pBuffer), pBuffer.remaining()));
    ...
    public void write_EEPROM(int addr, byte[] pBuffer) throws HRESULTException {
        errCheck(_lib.Altaircam_write_EEPROMArray(_handle, addr, pBuffer, pBuffer.length));
    }
    
    public int read_EEPROM(int addr, ByteBuffer pBuffer) throws HRESULTException {
        if (pBuffer.isDirect())
            return errCheck(_lib.Altaircam_read_EEPROM(_handle, addr, Native.getDirectBufferPointer(pBuffer), pBuffer.remaining()));
        else if (pBuffer.hasArray())
    ...
    public int read_EEPROM(int addr, byte[] pBuffer) throws HRESULTException {
        return errCheck(_lib.Altaircam_read_EEPROMArray(_handle, addr, pBuffer, pBuffer.length));
    }
    ...
    */
    public int rwc_Flash(int action, int addr, ByteBuffer pBuffer) throws HRESULTException {
        if (pBuffer.isDirect())
            return errCheck(_lib.Altaircam_rwc_Flash(_handle, action, addr, pBuffer.remaining(), Native.getDirectBufferPointer(pBuffer)));
        else if (pBuffer.hasArray())
    ...
    public int rwc_Flash(int action, int addr, byte[] pBuffer) throws HRESULTException {
        return errCheck(_lib.Altaircam_rwc_FlashArray(_handle, action, addr, pBuffer.length, pBuffer));
    }

    public void write_Pipe(int pipeId, ByteBuffer pBuffer) throws HRESULTException {
        if (pBuffer.isDirect())
            errCheck(_lib.Altaircam_write_Pipe(_handle, pipeId, Native.getDirectBufferPointer(pBuffer), pBuffer.remaining()));
        else if (pBuffer.hasArray())
    ...
    public void write_Pipe(int pipeId, byte[] pBuffer) throws HRESULTException {
        errCheck(_lib.Altaircam_write_PipeArray(_handle, pipeId, pBuffer, pBuffer.length));
    }
    
    public int read_Pipe(int pipeId, ByteBuffer pBuffer) throws HRESULTException {
        if (pBuffer.isDirect())
            return errCheck(_lib.Altaircam_read_Pipe(_handle, pipeId, Native.getDirectBufferPointer(pBuffer), pBuffer.remaining()));
        else if (pBuffer.hasArray())
    ...
    public int read_Pipe(int pipeId, byte[] pBuffer) throws HRESULTException {
        return errCheck(_lib.Altaircam_read_PipeArray(_handle, pipeId, pBuffer, pBuffer.length));
    }
    
    public void feed_Pipe(int pipeId) throws HRESULTException {
        errCheck(_lib.Altaircam_feed_Pipe(_handle, pipeId));
    }
    
    public void write_UART(ByteBuffer pBuffer) throws HRESULTException {
        if (pBuffer.isDirect())
            errCheck(_lib.Altaircam_write_UART(_handle, Native.getDirectBufferPointer(pBuffer), pBuffer.remaining()));
        else if (pBuffer.hasArray())
    ...
    public void write_UART(byte[] pBuffer) throws HRESULTException {
        errCheck(_lib.Altaircam_write_UARTArray(_handle, pBuffer, pBuffer.length));
    }
    
    public int read_UART(ByteBuffer pBuffer) throws HRESULTException {
        if (pBuffer.isDirect())
            return errCheck(_lib.Altaircam_read_UART(_handle, Native.getDirectBufferPointer(pBuffer), pBuffer.remaining()));
        else if (pBuffer.hasArray())
    ...
    public int read_UART(byte[] pBuffer) throws HRESULTException {
        return errCheck(_lib.Altaircam_read_UARTArray(_handle, pBuffer, pBuffer.length));
    }
    
    public void put_Option(int iOption, int iValue) throws HRESULTException {
        errCheck(_lib.Altaircam_put_Option(_handle, iOption, iValue));
    }
    
    public int get_Option(int iOption) throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Altaircam_get_Option(_handle, iOption, p));
        return p.getValue();
    }

    public int[] getPixelFormatSupport() throws HRESULTException {
        int num = get_PixelFormatSupport((byte)-1);
        if (num > 0) {
            int[] arr = new int[num];
            for (byte i = 0; i < num; i++)
                arr[i] = get_PixelFormatSupport(i);
            return arr;
        }
        return null;
    }
    ...
    */
    public int get_PixelFormatSupport(byte cmd) throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Altaircam_get_PixelFormatSupport(_handle, cmd, p));
        return p.getValue();
    }
    ...
    void put_Binning(Pointer h, String Value, String Method) throws HRESULTException {
        errCheck(_lib.Altaircam_put_Binning(_handle, Value, Method));
    }
    ...
    String[] get_Binning(Pointer h) throws HRESULTException {
        ...
        errCheck(_lib.Altaircam_get_Binning(_handle, pValue, pMethod));
    ...
    public String[] getBinningValue() throws HRESULTException {
        ...
        for (int i = 0; i < num; i++)
            arr[i] = get_BinningValue(i);
        return arr;
    }

    int get_BinningNumber() throws HRESULTException {
        return _lib.Altaircam_get_BinningNumber(_handle);
    }

    String get_BinningValue(int index) throws HRESULTException {
        PointerByReference pValue = new PointerByReference();
        errCheck(_lib.Altaircam_get_BinningValue(_handle, index, pValue));
    ...
    public String[] get_BinningMethod() {
        ...
        while (true) {
            try {
                String method = get_BinningMethod(index);
                methods.add(method);
                index++;
    ...
    String get_BinningMethod(int index) throws HRESULTException {
        PointerByReference pMethod = new PointerByReference();
        errCheck(_lib.Altaircam_get_BinningMethod(_handle, index, pMethod));
        return pMethod.getValue().getString(0);
    }

    public void writePtr(String key, Object data) throws HRESULTException {
        if (data == null) {
            errCheck(_lib.Altaircam_writePtr(_handle, key, 0, null));
        }
            ...
            if (buf.length == 0)
                ...
                errCheck(_lib.Altaircam_writePtr(_handle, key, buf.length, mem));
            }
        }
        else if (data instanceof String) {
            writePtr(key, ((String)data).getBytes());
        }
        else if (data instanceof Integer) {
            Memory mem = new Memory(4);
            mem.setInt(0, (Integer)data);
            errCheck(_lib.Altaircam_writePtr(_handle, key, 4, mem));
        }
        else if (data instanceof Long) {
            Memory mem = new Memory(8);
            mem.setLong(0, (Long)data);
            errCheck(_lib.Altaircam_writePtr(_handle, key, 8, mem));
        }
        else {
            errCheck(HRESULTException.E_INVALIDARG);
        }
    ...
    public byte[] readPtr(String key, int length) throws HRESULTException {
        if (length <= 0)
            return null;
        Memory mem = new Memory(length);
        errCheck(_lib.Altaircam_readPtr(_handle, key, length, mem));
        return mem.getByteArray(0, length);
    }

    /*
        String sa = readPtr("???", String.class)
        Integer ib = readPtr("???", Integer.class)
        Long lc = readPtr("???", Long.class)
    */
    public <T> T readPtr(String key, Class<T> clazz) throws HRESULTException {
        int size = 0;
        if (clazz == Integer.class) size = 4;
        else if (clazz == Long.class) size = 8;
        else if (clazz == String.class) size = 256;
        else errCheck(HRESULTException.E_INVALIDARG);

        Memory mem = new Memory(size);
        errCheck(_lib.Altaircam_readPtr(_handle, key, size, mem));
        if (clazz == Integer.class) return clazz.cast(mem.getInt(0));
        if (clazz == Long.class) return clazz.cast(mem.getLong(0));
        if (clazz == String.class) {
            byte[] tmp = mem.getByteArray(0, size);
            int len = 0;
            for (; len < tmp.length; len++) {
                if (tmp[len] == 0)
                    break;
            }
            return clazz.cast(new String(tmp, 0, len));
        }
        return null;
    }

    public void put_SelfTrigger(SelfTrigger pSt) throws HRESULTException {
        errCheck(_lib.Altaircam_put_SelfTrigger(_handle, pSt));
    }

    public SelfTrigger get_SelfTrigger() throws HRESULTException {
        SelfTrigger p = new SelfTrigger();
        errCheck(_lib.Altaircam_get_SelfTrigger(_handle, p));
        return p;
    }

    public void put_Linear(byte[] v8, short[] v16) throws HRESULTException {
        errCheck(_lib.Altaircam_put_Linear(_handle, v8, v16));
    }
    
    public void put_Curve(byte[] v8, short[] v16) throws HRESULTException {
        errCheck(_lib.Altaircam_put_Curve(_handle, v8, v16));
    }
    
    public void put_ColorMatrix(double[] v) throws HRESULTException {
        if (v.length != 9)
            errCheck(HRESULTException.E_INVALIDARG);
        errCheck(_lib.Altaircam_put_ColorMatrix(_handle, v));
    }
    
    public void put_InitWBGain(short[] v) throws HRESULTException {
        if (v.length != 3)
            errCheck(HRESULTException.E_INVALIDARG);
        errCheck(_lib.Altaircam_put_InitWBGain(_handle, v));
    }
    ...
    public short get_Temperature() throws HRESULTException {
        ShortByReference p = new ShortByReference();
        errCheck(_lib.Altaircam_get_Temperature(_handle, p));
        return p.getValue();
    }
    ...
    */
    public void put_Temperature(short nTemperature) throws HRESULTException {
        errCheck(_lib.Altaircam_put_Temperature(_handle, nTemperature));
    }
    ...
    */
    public void put_Roi(int xOffset, int yOffset, int xWidth, int yHeight) throws HRESULTException {
        errCheck(_lib.Altaircam_put_Roi(_handle, xOffset, yOffset, xWidth, yHeight));
    }
    ...
    public int[] get_Roi() throws HRESULTException {
        ...
        errCheck(_lib.Altaircam_get_Roi(_handle, p, q, r, s));
    ...
    public void put_RoiN(int[] xOffset, int[] yOffset, int[] xWidth, int[] yHeight) throws HRESULTException {
        ...
        errCheck(_lib.Altaircam_put_RoiN(_handle, xOffset, yOffset, xWidth, yHeight, xOffset.length));
    }
    ...
    */
    public int[] get_FrameRate() throws HRESULTException {
        ...
        IntByReference q = new IntByReference();
        IntByReference r = new IntByReference();
        errCheck(_lib.Altaircam_get_FrameRate(_handle, p, q, r));
        return new int[] { p.getValue(), q.getValue(), r.getValue() };
    }
    
    public void LevelRangeAuto() throws HRESULTException {
        errCheck(_lib.Altaircam_LevelRangeAuto(_handle));
    }
    
    /* Auto White Balance "Once", Temp/Tint Mode */
    public void AwbOnce() throws HRESULTException {
        errCheck(_lib.Altaircam_AwbOnce(_handle, null, null));
    }
    ...
    public void AwbInit() throws HRESULTException {
        errCheck(_lib.Altaircam_AwbInit(_handle, null, null));
    }
    
    public void AbbOnce() throws HRESULTException {
        errCheck(_lib.Altaircam_AbbOnce(_handle, null, null));
    }
    ...
    public void FfcOnce() throws HRESULTException {
        errCheck(_lib.Altaircam_FfcOnce(_handle));
    }
    ...
    public void DfcOnce() throws HRESULTException {
        errCheck(_lib.Altaircam_DfcOnce(_handle));
    }
    ...
    public void FpncOnce() throws HRESULTException {
        errCheck(_lib.Altaircam_FpncOnce(_handle));
    }
    
    public void FfcExport(String filePath) throws HRESULTException {
        if (Platform.isWindows())
            errCheck(((WinLibrary)_lib).Altaircam_FfcExport(_handle, new WString(filePath)));
        else
            errCheck(((CLibrary)_lib).Altaircam_FfcExport(_handle, filePath));
    }
    
    public void FfcImport(String filePath) throws HRESULTException {
        if (Platform.isWindows())
            errCheck(((WinLibrary)_lib).Altaircam_FfcImport(_handle, new WString(filePath)));
        else
            errCheck(((CLibrary)_lib).Altaircam_FfcImport(_handle, filePath));
    }
    
    public void DfcExport(String filePath) throws HRESULTException {
        if (Platform.isWindows())
            errCheck(((WinLibrary)_lib).Altaircam_DfcExport(_handle, new WString(filePath)));
        else
            errCheck(((CLibrary)_lib).Altaircam_DfcExport(_handle, filePath));
    }
    
    public void DfcImport(String filePath) throws HRESULTException {
        if (Platform.isWindows())
            errCheck(((WinLibrary)_lib).Altaircam_DfcImport(_handle, new WString(filePath)));
        else
            errCheck(((CLibrary)_lib).Altaircam_DfcImport(_handle, filePath));
    }
    
    public void FpncExport(String filePath) throws HRESULTException {
        if (Platform.isWindows())
            errCheck(((WinLibrary)_lib).Altaircam_FpncExport(_handle, new WString(filePath)));
        else
            errCheck(((CLibrary)_lib).Altaircam_FpncExport(_handle, filePath));
    }
    
    public void FpncImport(String filePath) throws HRESULTException {
        if (Platform.isWindows())
            errCheck(((WinLibrary)_lib).Altaircam_FpncImport(_handle, new WString(filePath)));
        else
            errCheck(((CLibrary)_lib).Altaircam_FpncImport(_handle, filePath));
    }
    
    public int IoControl(int ioLine, int eType, int outVal) throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Altaircam_IoControl(_handle, ioLine, eType, outVal, p));
        return p.getValue();
    }
    
    public int AAF(int action, int outVal) throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Altaircam_AAF(_handle, action, outVal, p));
        return p.getValue();
    }
    ...
    public void put_AFMode(int mode, int bFixedWD, int uiNear, int uiFar) throws HRESULTException {
        errCheck(_lib.Altaircam_put_AFMode(_handle, mode, bFixedWD, uiNear, uiFar));
    }

    public void put_AFRoi(int xOffset, int yOffset, int xWidth, int yHeight) throws HRESULTException {
        errCheck(_lib.Altaircam_put_AFRoi(_handle, xOffset, yOffset, xWidth, yHeight));
    }

    public void put_AFAperture(int iAperture) throws HRESULTException {
        errCheck(_lib.Altaircam_put_AFAperture(_handle, iAperture));
    }

    public void put_AFFMPos(int iFMPos) throws HRESULTException {
        errCheck(_lib.Altaircam_put_AFFMPos(_handle, iFMPos));
    }
    
    public FocusMotor get_FocusMotor() throws HRESULTException {
        FocusMotor pFocusMotor = new FocusMotor();
        errCheck(_lib.Altaircam_get_FocusMotor(_handle, pFocusMotor));
        return pFocusMotor;
    }
    ...
    private static void OnHistogramCallback(Pointer aHist, int nFlag, Pointer ctxHistogram) {
        Object o = null;
        synchronized (_hash) {
            o = _hash.get((int)Pointer.nativeValue(ctxHistogram));
        }
        if (o instanceof altaircam) {
            altaircam t = (altaircam)o;
    ...
    public void GetHistogram(IHistogramCallback cb) throws HRESULTException {
        ...
        if (Platform.isWindows()) {
            ...
            errCheck(((WinLibrary)_lib).Altaircam_GetHistogramV2(_handle, (WinLibrary.HISTOGRAM_CALLBACK)_histogramcallback, new Pointer(_objid)));
        }
        else {
            ...
            Native.setCallbackThreadInitializer(_histogramcallback, new CallbackThreadInitializer(false, false, "histogramcallback"));
            errCheck(((CLibrary)_lib).Altaircam_GetHistogramV2(_handle, (CLibrary.HISTOGRAM_CALLBACK)_histogramcallback, new Pointer(_objid)));
        }
    }

    public void put_XY(int x, int y) throws HRESULTException {
        errCheck(_lib.Altaircam_put_XY(_handle, x, y));
    }
    ...
    */
    public static void Replug(String camId) throws HRESULTException {
        if (Platform.isWindows())
            errCheck(((WinLibrary)_lib).Altaircam_Replug(new WString(camId)));
        else
            errCheck(((CLibrary)_lib).Altaircam_Replug(camId));
    }

    private static void OnProgressCallback(int percent, Pointer ctxProgress) {
        Object o = null;
        synchronized (_hash) {
            o = _hash.get((int)Pointer.nativeValue(ctxProgress));
        }
    ...
    */
    public static void Update(String camId, String filePath, IProgressCallback cb) throws HRESULTException {
        ...
        if (Platform.isWindows()) {
            ...
            errCheck(((WinLibrary)_lib).Altaircam_Update(new WString(camId), new WString(filePath), p, new Pointer(id)));
        }
        else {
            ...
            Native.setCallbackThreadInitializer(p, new CallbackThreadInitializer(false, false, "progressCallback"));
            errCheck(((CLibrary)_lib).Altaircam_Update(camId, filePath, p, new Pointer(id)));
        }
    }

    public static ModelV2 get_Model(short idVendor, short idProduct) {
        Pointer qtr = _lib.Altaircam_get_Model(idVendor, idProduct);
        if (qtr == null)
            return null;
    ...
    public static int[] Gain2TempTint(int[] gain) throws HRESULTException {
        ...
        errCheck(_lib.Altaircam_Gain2TempTint(gain, temp, tint));
    ...
    public static void TempTint2Gain(int temp, int tint, int[] gain) throws HRESULTException {
        if (gain.length != 3)
            errCheck(HRESULTException.E_INVALIDARG);
        _lib.Altaircam_TempTint2Gain(temp, tint, gain);
    }
}
