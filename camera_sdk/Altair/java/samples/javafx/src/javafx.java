    ...
    private void OnEventImage() {
        if (_cam != null) {
            try {
                ...
                ++_total;
            } catch (altaircam.HRESULTException ex) {
