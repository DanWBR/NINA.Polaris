            ...
            else
            {
                ...
                do {
                    if (fgets(str, 1023, stdin))
                    {
                        ...
                        {
                            Altaircam_IoControl(g_hcam, 0, ALTAIRCAM_IOCONTROLTYPE_SET_TRIGGERSOURCE, trigger_source, NULL);
							if (2 == trigger_source)
								Altaircam_IoControl(g_hcam, trigger_source, ALTAIRCAM_IOCONTROLTYPE_SET_GPIODIR, 0, NULL);
                            break;
                        }
                    }
                } while (true);
