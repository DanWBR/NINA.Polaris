Prerequisites:
    ...
    Add OpenCV 4.11.0 opencv2 header files and altaircam.h to the inc directory
    Add altaircam.lib to the lib directory
    Add altaircam.dll to the same directory as the executable file
