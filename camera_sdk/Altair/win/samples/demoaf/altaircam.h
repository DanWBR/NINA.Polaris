...
#define ALTAIRCAM_FRONTEND_MAX              1024    /* frontend frame buffer deque length */
#define ALTAIRCAM_FRONTEND_DEF              4
#define ALTAIRCAM_FRONTEND_MIN              2
#define ALTAIRCAM_BACKEND_MAX               1024    /* backend frame buffer deque length */
#define ALTAIRCAM_BACKEND_DEF               3
#define ALTAIRCAM_BACKEND_MIN               2
...
#endif
    const AltaircamModelV2* model;              /* Functionally equivalent to a global constant, remaining valid and unchanged throughout the lifetime of the process */
...
#define ALTAIRCAM_OPTION_CALLBACK_THREAD        0x30       /* [RW] dedicated thread for callback: 0 => disable, 1 => enable
...
#define ALTAIRCAM_OPTION_GVCP_TIMEOUT           0x71       /* [RW] GVCP Timeout: millisecond, range = [5, 150], default: 15(wire), 30(wireless)
                                                              Unless in very special circumstances, generally no modification is required, just use the default value
                                                         */
#define ALTAIRCAM_OPTION_GVCP_RETRY             0x72       /* [RW] GVCP Retry: range = [2, 16], default: 4(wire), 8(wireless)
                                                              Unless in very special circumstances, generally no modification is required, just use the default value
                                                         */
