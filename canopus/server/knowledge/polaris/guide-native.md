...
readout**, the live error vs the settle tolerance plus a progress indicator, so you can see it converge instead of guessing. The dither/settle state is also
