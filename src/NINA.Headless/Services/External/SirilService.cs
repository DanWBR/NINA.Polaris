...
///
/// Bundled scripts ship in src/NINA.Headless/Resources/SirilScripts/
...
public class SirilService {
    ...
    private string ExtractBundledScripts() {
        var targetDir = Path.Combine(
            Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),
            "NINA.Headless", "siril", "scripts-bundled");
        Directory.CreateDirectory(targetDir);

        var asm = Assembly.GetExecutingAssembly();
        // Resources are named NINA.Headless.Resources.SirilScripts.<filename>.ssf
        const string prefix = "NINA.Headless.Resources.SirilScripts.";
