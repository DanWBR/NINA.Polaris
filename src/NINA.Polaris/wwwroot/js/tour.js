...
(function () {
    ...
    function settingsSteps() {
        ...
        return [
            ...
            { target: '[data-tour="set-liveloop"]', placement: 'bottom', skipIfMissing: true, before: open, title: 'LIVE capture loop', body: 'Run the LIVE capture loop on the server instead of the browser (experimental): the session keeps capturing even if your browser disconnects, and the client only offloads stacking. Off by default.' },
