...
public class PluginSystemTests {
    ...
    public void RegisterPluginEntity_RoundTripsThroughJson() {
        ...
        var doc = new SequenceDocument {
            Name = "with-plugin",
            Root = new NINA.Headless.Services.Sequencer.Containers.SequentialContainer {
                Items = new() {
        ...
        var root = back.Root as NINA.Headless.Services.Sequencer.Containers.SequentialContainer;
